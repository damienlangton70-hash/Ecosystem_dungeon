...
| **Ironbark Deeproot** (timber) | *"Heavier than it looks, and it should be — this is what the Rhinox eat instead of turning around."* | Not eaten. Harvest **timber** for shelter builds and **weapon hafts** (ties into butchery-quality cut chain, see RECIPES.md 1.3); young **shoots** are Stonehide Rhinox forage, not player food. | Floor 2 (The Rootways) dominant, present Floor 1 |
...
| **Big-game cuts** | Chasm Drake, Gravemaw Ursine, Pale Sabertooth, Stonehide Rhinox | *Drake Sear-Cut* (hazard tag **requires-searing**, Campfire-only), *Ursine Feast-Cut*, *Sabertooth Prized Loin* (also drops a separate **Prized Hide** crafting item, not eaten), *Rhinox Charge-Cut* (extremely dangerous to harvest — narrative weight per FOOD_WEB "adults untouchable"). | Raw: edible, weak, high Bellyache risk (big meat, easy to botch). Cooked: recipes #24, #25, #26, #27. |
