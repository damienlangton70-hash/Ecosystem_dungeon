...
| 15 | **Rackjaw Rootways Ragout** | Rackjaw · Palethyme · Gloomgrape | CF | Stamina-regen ++ (stacked herb+fruit, see 1.7) | 7 min, Stamina-regen +35% total | *"Pack hunters run you ragged before you ever land a killing blow. This is the dish that pays that debt back."* |
...
| 25 | **Gorehorn Charge-Breaker Stew** | Stonehide Gorehorn · Deeproot Ginger · Duskfig | CF | Warmth ++, huge Hunger restore | Warmth: 8 min, +25%; Hunger +90% | *"You do not hunt a Gorehorn for sport. You hunt it because the ecosystem note says adults are untouchable and you have decided, against all sense, otherwise. Cook it with respect."* |
